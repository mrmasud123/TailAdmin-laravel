...
@section('vendor-scripts')
    @vite(['resources/assets/js/good-receipt-note/good-receipt-note.js']);
@endsection
@section('content')
    ...
    <div class="bg-white dark:bg-white/5 rounded-2xl shadow-lg p-6">
        ...
        <div class="flex flex-wrap items-end gap-3 mb-6">
            <div class="flex-1 min-w-45">
                <label class="text-xs text-gray-500 dark:text-gray-300">Supplier</label>
                <select id="filter_supplier" class="mt-1 w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 text-sm">
            ...
            <div class="flex-1 min-w-40">
                <label class="text-xs text-gray-500 dark:text-gray-300">Receipt Date</label>
                <x-form.date-picker id="filter_receipt_date" name="receipt_date"
                                    class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100"
                                    placeholder="Date Picker" />
            </div>
            <div class="flex items-end gap-2 ms-auto">
                <button id="btn_filter" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm rounded-lg shadow transition">Filter</button>
                <button id="btn_reset" class="px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm rounded-lg shadow transition">Reset</button>
            </div>
        </div>

        <div class="overflow-x-auto">
            <table id="grn-table" class="min-w-full text-sm w-full">
                <thead class="bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-200 uppercase text-xs">
                <tr>
                    <th class="px-4 py-3 text-left">GRN No.</th>
{{--                    <th class="px-4 py-3 text-left">PO No.</th>--}}
