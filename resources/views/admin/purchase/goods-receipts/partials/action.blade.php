{{-- resources/views/admin/grn/partials/actions.blade.php --}}
<div class="flex items-center justify-center gap-1">
    <a href="{{ route('admin.grn.show', $grn->id) }}" title="View"
    ...
    <a href="{{ route('admin.grn.edit', $grn->id) }}" title="Edit"
    ...
    <button type="button" class="btn-delete-grn p-1.5 rounded-lg text-red-500 hover:bg-red-50 hover:text-red-700 dark:hover:bg-red-500/10" data-id="{{ $grn->id }}" title="Delete">
