<div class="flex items-center justify-center gap-1">
    <a href="{{ route('admin.purchase-order.print', $po->id) }}" title="Print"
    ...
    <a href="{{ route('admin.purchase-order.edit', $po->id) }}" title="Edit"
    ...
    <button title="Delete" class="js-delete-po p-1.5 rounded-lg text-red-500 hover:bg-red-50 hover:text-red-700 dark:hover:bg-red-500/10" data-id="{{ $po->id }}">
